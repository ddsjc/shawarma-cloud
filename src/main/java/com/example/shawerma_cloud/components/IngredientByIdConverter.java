package com.example.shawerma_cloud.components;
...
public class IngredientByIdConverter implements Converter<String, Ingredient> {
    ...
    public IngredientByIdConverter() {
        ingredientMap.put("FLTO", new Ingredient("FLTO", "Flour Torilla", Ingredient.Type.WRAP));
        ingredientMap.put("COTO", new Ingredient("COTO", "Corn Torilla", Ingredient.Type.WRAP));
